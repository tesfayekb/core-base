...
export function AuditMetricsGrid({ metrics }: AuditMetricsGridProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-red-600">{metrics?.securityEvents || 0}</div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            {metrics?.failureRate?.toFixed(1) || 0}%
          </div>
        </CardContent>
      </Card>
